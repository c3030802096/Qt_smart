    ...
    ui(new Ui::DeviceFan)
{
    ...
    ui->label_fan->setStyleSheet("border-image:url(:/png/fengshan_guan.png)");
    ui->label_fan->setText("");
}

bool DeviceFan::isFanOn() const
{
    return fanStatus;//
}
...
void DeviceFan::slot_slider_ON(void)
{
    ...
    ui->label_fan->setStyleSheet("border-image:url(:/png/fengshan_kai.png)");
...
//关闭风扇
void DeviceFan::closefan()
{
    qDebug() << "closefan 函数被调用";
    slot_slider_OFF();
}
